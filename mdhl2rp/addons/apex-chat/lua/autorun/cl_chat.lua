----// eChat (ApexRoleplay edition) //----
-- Author: Exho (obviously), Tomelyr, LuaTenshi, TheVingard
-- Version: 28/12/2016
...
function chat.AddText(...)
	...
	for _, obj in pairs( {...} ) do
		...
		elseif obj:IsPlayer() then
			...
			if eChat.config.timeStampsffdtr then
			...
			eChat.chatLog:InsertColorChange( col.r, col.g, col.b, 255 ) -- TESTS: eChat.chatLog:InsertColorChange( col.r, col.g, col.b, 255 )
